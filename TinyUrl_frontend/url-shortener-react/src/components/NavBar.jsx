...
const Navbar = () => {
  ...
  return (
    <div className="h-16 bg-gradient-to-r from-blue-500 to-teal-500  z-50 flex items-center sticky top-0 ">
      <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
        ...
        <ul
          ...
          }  transition-all duration-100 sm:h-fit sm:bg-none  bg-gradient-to-r from-blue-500 to-teal-500 sm:w-fit w-full sm:flex-row flex-col px-4 sm:px-0`}
        >
