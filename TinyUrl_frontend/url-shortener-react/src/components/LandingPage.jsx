            ...
            <div className="lg:flex-row flex-col    lg:py-5   pt-16   lg:gap-10 gap-8 flex justify-between items-center">
                <div className=" flex-1">
                    <motion.h
                        ...
                        className='font-bold font-roboto text-slate-800 md:text-5xl text-3xl md:leading-[55px] sm:leading-[45px] leading-10 lg:w-full md:w-[70%] w-full' >TinyUrl Simplifies Url Shortening</motion.h>
                    <p className="text-slate-700 text-sm my-5">
                        TinyUrl streamlines the process of URL shortening, making sharing
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <motion.button
                            ...
                            viewport={{ once: true }}
                            transition={{ duration: 1 }}
                            className="bg-gradient-to-r from-blue-500 to-teal-500 w-40 text-white rounded-md py-2">
                            Manage Links
                        </motion.button>
                        <motion.button
                            initial={{ opacity: 0, y: 80 }}
